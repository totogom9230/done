        ...
        if (starDates[key]) {
            ...
            img.addEventListener('mousedown', (e) => {
                ...
                pressTimer = setTimeout(() => {
                    longPressing = true;
                    img.classList.add('long-pressing');
            ...
            img.addEventListener('mouseup', (e) => {
                ...
                if (!longPressing) img.classList.remove('long-pressing');
            });
            img.addEventListener('mouseleave', (e) => {
                clearTimeout(pressTimer);
                img.classList.remove('long-pressing');
            });
            ...
            if (scores[key]) {
                ...
                if (scores[key] >= 500) scoreElem.classList.add('score-gold');
                else if (scores[key] >= 100) scoreElem.classList.add('score-silver');
                else scoreElem.classList.add('score-bronze');
...
// Confirm modal logic
let deleteKeyToRemove = null;
function showDeleteConfirm(key) {
    deleteKeyToRemove = key;
    document.getElementById('confirm-modal').style.display = 'flex';
}
function hideDeleteConfirm() {
    deleteKeyToRemove = null;
...
document.getElementById('confirm-delete').addEventListener('click', function() {
    if (deleteKeyToRemove) {
        ...
        delete scores[deleteKeyToRemove];
        setStarDates(starDates);
        setScores(scores);
        renderCalendar(currentYear, currentMonth);
